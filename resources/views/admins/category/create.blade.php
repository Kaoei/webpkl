...
<div class="bg-white p-8 rounded-lg shadow-lg  w-full">
    ...
    <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="mt-2 block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-4 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" id="category" name="name" placeholder="name" required>
        </div>
